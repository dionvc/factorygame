...
namespace EngineeringCorpsCS
{
    static class Props
    {
        ...
        public const float worldMapZoomMin = 2.0f; //hardcoded for performance reasons
        public const float worldMapZoomMax = 4.0f; //hardcoded for performance reasons
        public const float cameraZoomMin = 1.0f;
        public const float cameraZoomMax = 8.0f;
