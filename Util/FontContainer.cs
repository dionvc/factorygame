...
namespace EngineeringCorpsCS
{
    class FontContainer
    {
        ...
        public FontContainer()
        {
            ...
            nullFont = new Font("Fonts/SairaRegular.ttf");
        }
        public void LoadFonts()
        {
            try
            {
                List<string> textureFileNames = new List<string>(Directory.EnumerateFiles(Directory.GetCurrentDirectory() + "/Fonts", "*.ttf", SearchOption.AllDirectories));
