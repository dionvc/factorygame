...
namespace EngineeringCorpsCS
{
    class Tile: Base
    {
        ...
        public Tile(Texture tileSheet, byte tileType, string name, float frictionModifier, Color shade, Color mapColor, CollisionLayer collisionMask, float mA, float eA, float tA)
        {
